# Data Warehousing Project with SQL
...
### Specifications
  ...
  <br> 2. **Data Quality:** Cleanse and resolve data quality issues prior to analysis.
  <br> 3. **Integration:** Combine both sources into a single, user-friendly data model designed for analytical queries.
  <br> 4. **Scope:** Focus on the latest dataset only; historization of data is not required.
  <br> 5. **Documentation:** Provide clear documentation of the data model to support both business stakeholders and analytics teams.
